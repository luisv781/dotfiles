class DateTime {
	...
	_setTime() {
		...
		this._greeterDate.innerText = `${this._daysArr[date.getDay()]}, ${this._monthsArr[date.getMonth()]} ` +
			`${this._appendZero(date.getDate())}`; //${this._getDayOrdinal(this._appendZero(date.getDate()))}
